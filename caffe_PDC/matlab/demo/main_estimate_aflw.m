...
parent_path = './VGG_AFLW';
result_path = './results_AFLW';

img_list_path = fullfile(parent_path, 'test_list.txt');
model_file = fullfile(parent_path, 'facial_point_iter_390000.caffemodel');
model_def_file = fullfile(parent_path, 'deploy.prototxt');
mat_result_path = fullfile(result_path, 'VGG-AFLW-390000.mat');
...
align_errors = ComputeError(gt_pts, detected_points, gt_rects);
